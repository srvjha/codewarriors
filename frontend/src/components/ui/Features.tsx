    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 md:auto-rows-[240px] auto-rows-auto  items-start">
      <div className="bg-neutral-900/10 relative border border-neutral-800 rounded-2xl px-6 py-10 hover:shadow-md hover:shadow-neutral-500/40 col-span-6 lg:col-span-2 row-span-1  lg:row-span-1">
        ...
        <p className="text-sm text-gray-400">
          Master Data Structures and Algorithms through a well-organized
          collection of problems categorized by topic such as Arrays, Strings,
          Dynamic Programming, Trees, and Graphs. Filter problems based on
          difficulty level or company-specific patterns to align your
          preparation with your target job.
        </p>
      </div>
      ...
      <div className="bg-neutral-900/10 relative border border-neutral-800 rounded-2xl px-6 py-6 hover:shadow-md hover:shadow-neutral-500/40 col-span-6 lg:col-span-2 row-span-2  lg:row-span-2">
        ...
        <p className="text-sm text-gray-300">
          Struggling with a problem? Instantly initiate a conversation with
          AlgoAI, your intelligent assistant designed to explain concepts, guide
          you through solution steps, and answer questions contextually.
        </p>
        <div className="-mb-6">
      ...
      <div className="bg-neutral-900/10 relative border border-neutral-800 rounded-2xl px-6 py-6 hover:shadow-md hover:shadow-neutral-500/40 col-span-6 lg:col-span-2 row-span-2  lg:row-span-2">
        ...
        <p className="text-sm text-gray-300 ">
          Dive into your personalized dashboard showcasing your coding progress.
          Track solved problems, monitor your daily streak, and analyze
          submission trends through interactive graphs. View recent submissions,
      ...
      <div className="bg-neutral-900/10 relative border border-neutral-800 rounded-2xl px-6 py-10 hover:shadow-md hover:shadow-neutral-500/40 col-span-6 lg:col-span-2    lg:row-span-1 ">
        ...
        <p className="text-sm text-gray-400">
          Access curated practice sheets for different topics and difficulty
          levels, or create your own personalized problem sets.
        </p>
      </div>
      ...
      <div className="bg-neutral-900/10 relative border border-neutral-800 rounded-2xl px-6 py-10  hover:shadow-md hover:shadow-neutral-500/40 col-span-6 lg:col-span-4  lg:row-span-1 md:-mt-14   ">
        ...
        <p className="text-sm text-gray-400">
          Write, test, and run code in a feature-rich environment built for
          competitive programming and interview preparation. The editor supports
          multiple languages, intelligent autocompletion, and real-time
          feedback.
        </p>
      ...
      <div className="bg-neutral-900/10 relative border border-neutral-800 rounded-2xl px-6 py-10 hover:shadow-md hover:shadow-neutral-500/40 col-span-6 lg:col-span-2  lg:row-span-1 lg:-mt-14">
        ...
        <p className="text-sm text-gray-400">
          Engage with a vibrant community of coders. Ask doubts, discuss
          problem-solving techniques, and share your interview experiences.
        </p>
      </div>
      ...
      <div className="bg-neutral-900/10 relative border border-neutral-800 rounded-2xl px-6 py-16 hover:shadow-md hover:shadow-neutral-500/40 col-span-6 lg:col-span-2  lg:col-start-5 lg:-mt-28">
        ...
        <p className="text-sm text-gray-400">
          Stay consistent and motivated with a gamified daily streak system.
          Visualize your consistency, analyze day-wise performance, and push
          yourself to keep the momentum going. The system highlights your
          improvement over time, making it easier to spot weak areas and
