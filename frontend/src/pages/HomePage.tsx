        ...
        <div className="text-white px-6 py-12 md:py-24 min-h-screen">
          <div className="max-w-3xl mx-auto flex flex-col items-center gap-12 -mt-6 text-center">
            <motion.div
              ...
              className="w-full"
            >
              <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-500">
                Code. Compete. Conquer.
              </h1>

              <p className="text-gray-300 text-lg max-w-2xl mx-auto mb-8">
                Step into the ultimate coding arena. Solve real-world
                challenges, track your progress, and became a CodeWarrior
              </p>
